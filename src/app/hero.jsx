  ...
  return (
    <div className='bg-cover bg-hero relative'>
      <div className='min-h-[100%] w-[100%] container mx-auto items-center xl:px-[5%] px-[5%] md:px-0'>
        ...
        <div
          className="relative z-10 grid grid-cols-1 md:grid-cols-2 h-[80%] items-center pb-[30px]"
        >
          <motion.p
            className='font-cabin font-[700] text-[30px] md:text-[42px] lg:text-[53px] mt-[60px] md:mt-0 text-white'
